...
(function (window, document) {
    ...
    var isTypeOf = function (item, type) { return typeof item === type; };
    var isString = function (item) { return isTypeOf(item, typeof_string); };
    var isUndefined = function (item) { return isTypeOf(item, typeof_undefined); };
    var isFunction = function (item) { return isTypeOf(item, typeof_function); };

    var isObject = function (item) { return isTypeOf(item, typeof_object); };
    ...
    var generateSimpleCart = function (space) {
        ...
        var selectorEngines = {
            ...
            // Currencies
            currencies = {
                "USD": { code: "USD", symbol: "R", name: "US Dollar" },
            ...
            settings = {
                ...
                cartStyle: "table",
                cartColumns: [
                    { view: "image", attr: "thumb", label: "Product Image" },
                    { attr: "name", label: "Name Of Product" },
                    { attr: "price", label: "Item Price", view: 'currency' },
                    { view: "decrement", label: false },
                    { attr: "quantity", label: "Qauntity" },
                    { view: "increment", label: false },
                    { attr: "total", label: "SubTotal", view: 'currency' },
                    //{ attr: "remove", label: "<th>Remove</th>" },
                    ...
                    //{ view: "", label: false },
                    //{ attr: "", label: "", view: '' },
                    { view: "remove", text: "Remove", label: "Remove Item" }
                ],
...
// main simpleCart object, function call is used for setting options
        ...
        simpleCart.extend({
            ...
            XX: function () {
                ...
                simpleCart.each(function (item) {
                    //var a = document.getElementById("msg").innerHTML = ( xxx += item.get('name') + "<br>");

                    //Element.innerHTML=
                    xxx += item.get('quantity') + "X";
                    xxx += item.get('name') + "|";
        ...
        simpleCart.Item._ = simpleCart.Item.prototype = {
            ...
            nam: function (val) {
                return isUndefined(val) ? parseInt(this.get("name", true) || 1, 10) : this.set("name", val);
            },
