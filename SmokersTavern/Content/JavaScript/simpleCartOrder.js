		...
		generateSimpleCart = function (space) {
		    ...
		    var selectorEngines = {
				...
				settings = {
				    ...
				    cartStyle: "div",
				    cartColumns: [
						{ attr: "name", label: "<tr><th>Name Of Product</th>" },
						{ attr: "price", label: "<th>Item Price</th>", view: 'currency' },
						//{ view: "decrement", label: false },
						{ attr: "quantity", label: "<th>Qauntity</th>" },
						//{ view: "increment", label: false },
						{ attr: "total", label: "<th>SubTotal</th></tr>", view: 'currency' }
