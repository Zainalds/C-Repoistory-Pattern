...
namespace SmokersTavern {
    ...
    public partial class ProductsDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ProductsRow AddProductsRow(string ProductName, string ProductDescription, string BrandName, string ProductColor, int ProductQuantity, decimal ProductPrice, string ImageUrl, int CategoryId, string CategoryName) {
            ...
            private void InitClass() {
                ...
                this.columnProductColor.MaxLength = 2147483647;
        ...
        public partial class ProductsRow : global::System.Data.DataRow {
            ...
            public string ProductColor {
                get {
                    return ((string)(this[this.tableProducts.ProductColorColumn]));
                }
                set {
                    this[this.tableProducts.ProductColorColumn] = value;
                }
            }
...
namespace SmokersTavern.ProductsDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Products] ([ProductName], [ProductDescription], [BrandName], [ProductColor], [ProductQuantity], [ProductPrice], [ImageUrl], [CategoryId], [CategoryName]) VALUES (@ProductName, @ProductDescription, @BrandName, @ProductColor, @ProductQuantity, @ProductPrice, @ImageUrl, @CategoryId, @CategoryName)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ProductColor", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ProductColor", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [ProductName] = @ProductName, [ProductDescription] = @ProductDescription, [BrandName] = @BrandName, [ProductColor] = @ProductColor, [ProductQuantity] = @ProductQuantity, [ProductPrice] = @ProductPrice, [ImageUrl] = @ImageUrl, [CategoryId] = @CategoryId, [CategoryName] = @CategoryName WHERE (([Id] = @Original_Id))";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ProductColor", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ProductColor", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, ProductName, ProductDescription, BrandName, ProductColor, ProductQuant" +
                "ity, ProductPrice, ImageUrl, CategoryId, CategoryName FROM dbo.Products";
        ...
        public virtual int Insert(string ProductName, string ProductDescription, string BrandName, string ProductColor, int ProductQuantity, decimal ProductPrice, string ImageUrl, int CategoryId, string CategoryName) {
            if ((ProductName == null)) {
            ...
            if ((ProductColor == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[3].Value = ((string)(ProductColor));
            }
        ...
        public virtual int Update(string ProductName, string ProductDescription, string BrandName, string ProductColor, int ProductQuantity, decimal ProductPrice, string ImageUrl, int CategoryId, string CategoryName, int Original_Id) {
            if ((ProductName == null)) {
                throw new global::System.ArgumentNullException("ProductName");
            }
            else {
            ...
            if ((ProductColor == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(ProductColor));
            }
